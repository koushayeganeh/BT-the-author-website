...
const Container = styled.div`
  ...
  height: 100%;
  position: relative;
  background-image: url("contact-1-back.png");
...
const OverlayImageHome = styled.div`
  width: 100%;
  height: 100%;
  position: relative;
  background-image: url("contact-1-overlay.png");
  background-size: cover;
  background-repeat: no-repeat;
  background-position: center bottom;
  overflow: hidden;
...
const ContactHeaderContainer = () => {
  ...
  return (
    ...
    >
      <OverlayContainer>
        {isHovering && <OverlayImageHome></OverlayImageHome>}
      </OverlayContainer>
...
export default ContactHeaderContainer;
